...
export default function AsiReportModal({
  ...
  const getMonumentCost = () => {
    ...
    return `₹ ${data.proactiveLakhs} Lakhs (ConservationCostAI Model Estimate)`;
  };
        ...
        <div className="print:hidden bg-[#FAF8F5] border-b border-[#E6E1D8] px-6 py-4 flex flex-wrap justify-between items-center gap-3">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <div className="text-[10px] font-mono text-[#7A5B49]">
          ...
          {!isAuthenticated ? (
            <div className="bg-white border-2 border-[#C85A32]/25 rounded-3xl p-8 shadow-xl space-y-6 text-center my-4">
              ...
              <div className="pt-4 border-t border-[#E6E1D8] max-w-lg mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 text-xs font-mono">
                <span className="text-[#7A5B49] text-[11px]">⚡ Fast Demo Access:</span>
                <div className="flex gap-2">
                  <button
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 mt-0.5">
                      {officerDesignation} · Jurisdiction: <strong className="text-gray-200">{officerCircle}</strong> · Service ID: <strong className="text-[#C29244]">{officerServiceId}</strong>
                    </p>
                  </div>
                </div>

                <div className="flex items-center gap-3">
                  <label className="flex items-center gap-2 bg-[#0E1013] px-3.5 py-2 rounded-lg border border-[#2B313D] cursor-pointer hover:border-[#C29244]">
                    <input
                      type="checkbox"
                      checked={isSignOffComplete}
                      onChange={(e) => setIsSignOffComplete(e.target.checked)}
                      className="rounded text-[#C29244] w-4 h-4"
                    />
